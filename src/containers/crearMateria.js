            ...
            <div style={styles}>
                ...
                <div className="form-row">
                    <div className="form group col-auto">
                        <label>Pensum</label>
                        <select className="form-control" name="pensum" onChange={this.handleChange} required>
                    ...
                    <div className="form-group col-auto">
                        ...
                        <select className="form-control" name="semestre" value={this.props.semestre} onChange={this.handleChange}>
                            <option>1</option>
                        </select>
                    </div>
                </div>
                <div className="form-row align-items-center">
                    <div className="form-group col-auto">
                        <label>Sigla</label>
                        <input className="form-control" type="text" name="sigla" placeholder="Sigla"
                ...
                <div className="form-row align-items-center">
                    <div className="form-group col-auto">
                        <label>Tipo</label>
                        <select className="form-control" value={this.props.tipo}
